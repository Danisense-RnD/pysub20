...
from sub20._errors import SubDeviceError, SubNotFoundError
...
class SUBDevice(object):
    def __init__(self, buffer_size=64):
        libname = 'lib/libsub.dll' if sys.platform == "win32" \
            else 'libsub.so'
    ...
    def open(self):
        ...
        rs_config = RS_RX_ENABLE | RS_TX_ENABLE | RS_CHAR_8 | RS_PARITY_NONE | RS_STOP_1

        self.sub_rs_set_config(0, 9600)
        self.sub_rs_set_config(rs_config, 9600)
